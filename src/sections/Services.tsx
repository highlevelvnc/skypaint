...
export default function Services() {
  return (
    <section id="servicos" className="relative py-32 bg-[#0a0e38]">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <Reveal
            className="md:col-span-8 h-[500px] group relative overflow-hidden rounded-xl bg-[#151a4c]"
            duration={800}
          >
            <img
              src={SERVICES[1].cover}
              alt={SERVICES[1].title}
              className="absolute inset-0 w-full h-full object-cover opacity-40 transition-transform duration-700 ease-out group-hover:scale-110"
            />
            ...
            <div className="relative z-10 flex flex-col justify-end h-full p-8">
              ...
              <a
                href="#trabalhos"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#00d2fd]/10 border border-[#00d2fd]/20 text-[#00d2fd] text-sm font-medium transition-colors duration-300 hover:bg-[#00d2fd]/20 w-fit"
              >
                Ver trabalhos
          ...
          <Reveal
            className="md:col-span-4 h-[500px] group relative overflow-hidden rounded-xl bg-[#1b2055]"
            duration={800}
            delay={100}
          >
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover opacity-30 transition-transform duration-700 ease-out group-hover:scale-110"
            />
          ...
          <Reveal
            className="md:col-span-4 h-[400px] group relative overflow-hidden rounded-xl bg-[#0a0e38] border border-white/5"
            duration={800}
            delay={50}
          >
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover opacity-20 transition-transform duration-700 ease-out group-hover:scale-105"
            />
          ...
          {/* ━━━ 4. Deck de Madeira ━━━ */}
          <Reveal
            className="md:col-span-4 h-[400px] group relative overflow-hidden rounded-xl bg-[#1b2055] border border-[#00d2fd]/10 transition-colors duration-500 hover:border-[#00d2fd]/30"
            duration={800}
            delay={100}
          >
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover opacity-30 transition-transform duration-700 ease-out group-hover:scale-105"
            />
          ...
          <Reveal
            className="md:col-span-4 h-[400px] group relative overflow-hidden rounded-xl bg-[#151a4c]"
            duration={800}
            delay={150}
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <Layers
                className="w-48 h-48 text-white/[0.03] transition-transform duration-700 group-hover:scale-110 group-hover:rotate-6"
                strokeWidth={0.5}
              />
            </div>
          ...
          <Reveal
            className="md:col-span-6 h-[350px] group relative overflow-hidden rounded-xl bg-[#0a0e38] border border-white/5"
            duration={800}
            delay={50}
          >
            <img
          ...
          {/* ━━━ 7. Marido de Aluguer ━━━ */}
          <Reveal
            className="md:col-span-6 h-[350px] group relative overflow-hidden rounded-xl bg-[#1b2055]"
            duration={800}
            delay={100}
          >
